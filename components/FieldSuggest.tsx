    ...
    <div className={`relative ${className}`}>
      <div className="flex items-center gap-1">
        <input
          ...
          className="flex-1 px-3 py-2 text-sm text-gray-900 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-300 placeholder-gray-500"
          autoComplete="off"
        />
        <button
          type="button"
